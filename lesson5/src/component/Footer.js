        ...
        <div className="footer">
            <div className="footer-info">
                <div className="main-footer1 main-footer">
                    ...
                    <p>
                        Hệ thống ngân hàng xuyên quốc gia đáng tin cậy. Dẫn đầu trong danh sách các ngân hàng được người
                        dùng bình chọn và được tin dùng bởi hàng triệu người dùng ở hầu hết các quốc gia trên thế giới.
                    </p>
                </div>
